...
function ContainerGrid(props){
    ...
    'es': 'Ver detalles', 'tr': 'Detayları göster', 'uk': 'Докладніше', 'uz': "Tafsilotlarni ko'rish", 'vi': 'Xem chi tiết', 'yi': 'View דעטאַילס', 'nl': 'Bekijk meer details', 'ru': 'Просмотреть более подробную информацию'};
